...
HD_PWD='E:/personals/PaklogicTech/VHDL/SHA256/work/sha256_vhdl/sha256_vhdl.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log round.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source round.tcl
