...
HD_PWD='E:/personals/PaklogicTech/VHDL/SHA256/work/sha256_vhdl/sha256_vhdl.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log round.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source round.tcl -notrace
